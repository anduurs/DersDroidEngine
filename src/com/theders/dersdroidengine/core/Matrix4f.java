...
public class Matrix4f {
	...
	public Vector3f mul(Vector3f v){
		return new Vector3f(m_Matrix[0][0] * v.getX() + m_Matrix[0][1] * v.getY() + m_Matrix[0][2] * v.getZ() + m_Matrix[0][3],
		                    m_Matrix[1][0] * v.getX() + m_Matrix[1][1] * v.getY() + m_Matrix[1][2] * v.getZ() + m_Matrix[1][3],
		                    m_Matrix[2][0] * v.getX() + m_Matrix[2][1] * v.getY() + m_Matrix[2][2] * v.getZ() + m_Matrix[2][3]);
	}
